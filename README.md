...
The current snapshot contains 39 models, 8 benchmarks, and 287 scores. The original 2026-07-17 seed, the subsequent model refresh, and the 2025 back-catalog addition are documented in the decision log in `PLAN.md`.
